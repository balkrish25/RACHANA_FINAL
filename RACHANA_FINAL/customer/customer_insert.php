...
$sql->bind_param("sissssss",$customer_name,$customer_contact,$customer_email,$customer_address,$customer_type,$customer_username,$customer_password,$customer_date);
if($sql->execute())
{
