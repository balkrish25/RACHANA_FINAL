...
?>
<form class="form form-horizontal" action="extra_charges_update.php" method="post" onsubmit="return ValidateForm();" enctype="multipart/form-data">
<div class="form-body">
...
<div class="col-md-9">
<input type="text" class="form-control" placeholder="TAX" name="ec_tax" id="ec_tax" value="<?php echo $row['ec_tax'];?>">
...
<div class="col-md-9">
<input type="text" class="form-control" placeholder="DISCOUNT" name="ec_discount" id="ec_discount" value="<?php echo $row['ec_discount'];?>">
...
<div class="col-md-9">
<input type="text" class="form-control" placeholder="MINIMUM AMOUNT" name="ec_min_amount" id="ec_min_amount" value="<?php echo $row['ec_min_amount'];?>">
