...
<center><h4 class="card-title" id="horz-layout-card-center">PRODUCT TYPE FORM</h4></center>
...
<form class="form form-horizontal" action="product_type_insert.php" method="post" onsubmit="return ValidateForm();" enctype="multipart/form-data">
<div class="form-body">
<div class="form-group row">
<label class="col-md-3 label-control" for="eventRegInput1">TYPE</label>
<div class="col-md-9">
<input type="text" class="form-control" placeholder="TYPE" name="pt_name" id="pt_name">
...
<div class="col-md-9">
<input type="text" class="form-control" placeholder="QUALITY" name="pt_quality" id="pt_quality">
