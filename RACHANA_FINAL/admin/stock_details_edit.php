...
<center><h4 class="card-title" id="horz-layout-card-center">STOCK DETAILS EDIT</h4></center>
...
<?php
$sd_id=$_REQUEST["id"]; 
$sql=$conn->prepare("SELECT * FROM stock_details sd,product_details pd WHERE sd.pd_id=pd.pd_id AND sd.sd_id=?"); 
$sql->bind_param("i",$sd_id); 
$sql->execute();
$result=$sql->get_result();
$row=$result->fetch_assoc(); 
?>
<form class="form form-horizontal" action="stock_details_update.php" method="post" onsubmit="return ValidateForm();" enctype="multipart/form-data">
<div class="form-body">
<input type="hidden" name="sd_id" id="sd_id" value="<?php echo $row["sd_id"];?>">

<div class="form-group row">
<label class="col-md-2 label-control" for="eventRegInput1">PRODUCT NAME</label>
<div class="col-md-9">
<input type="hidden" name="pd_id" id="pd_id" value="<?php echo $row["pd_id"];?>" class="form-control"> 
<input type="text" name="pd_name" id="pd_name" value="<?php echo $row["pd_name"];?>" class="form-control" readonly>  
</div>
</div>
...
<div class="col-md-9">
<input type="text" class="form-control" placeholder="Enter Unit Price" name="sd_unitprice" id="sd_unitprice" value="<?php echo $row["sd_unitprice"];?>">
...
<div class="col-md-9">
<input type="text" class="form-control" placeholder="Enter Discount" name="sd_discount" id="sd_discount" value="<?php echo $row["sd_discount"];?>">
...
<div class="col-md-9">
<input type="text"  class="form-control" placeholder="Enter Minimum Quantity Order" name="sd_min_qty_order" id="sd_min_qty_order" value="<?php echo $row["sd_min_qty_order"];?>">
...
<div class="col-md-9">
<input type="text"  class="form-control" placeholder="Enter Maximum Quantity Order" name="sd_max_qty_order" id="sd_max_qty_order" value="<?php echo $row["sd_max_qty_order"];?>">
...
<select name="sd_status" id="sd_status" class="form-control">
 <option value="<?php echo $row["sd_status"];?>"><?php echo $row["sd_status"];?></option>
...
if (sd_unitprice == 1  && sd_discount == 1 && sd_min_qty_order == 1 && sd_max_qty_order == 1 && sd_status == 1 ) 
{
return true;
}
else
