...
<center><h4 class="card-title" id="horz-layout-card-center">PRODUCT CATEGORY FORM</h4></center>
...
<form class="form form-horizontal" action="product_category_insert.php" method="post" onsubmit="return ValidateForm();" enctype="multipart/form-data">
<div class="form-body">
<div class="form-group row">
<label class="col-md-3 label-control" for="eventRegInput1">CATEGORY NAME</label>
<div class="col-md-9">
<input type="text" class="form-control" placeholder="CATEGORY NAME" name="pc_name" id="pc_name">
