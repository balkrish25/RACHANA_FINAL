...
<center><h4 class="card-title" id="horz-layout-card-center">PRODUCT UNITS FORM</h4></center>
...
<form class="form form-horizontal" action="product_units_insert.php" method="post" onsubmit="return ValidateForm();" enctype="multipart/form-data">
<div class="form-body">
<div class="form-group row">
<label class="col-md-3 label-control" for="eventRegInput1">UNIT TYPE</label>
<div class="col-md-9">
<input type="text" class="form-control" placeholder="UNIT TYPE" name="pu_type" id="pu_type">
