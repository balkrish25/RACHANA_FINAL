...
<center><h4 class="card-title" id="horz-layout-card-center">PORTFOLIO FORM</h4></center>
...
<div class="card-body">
<form class="form form-horizontal" action="portfolio_insert.php" method="post" onsubmit="return ValidateForm();" enctype="multipart/form-data">
<div class="form-body">
<div class="form-group row">
<label class="col-md-2 label-control" for="eventRegInput1">NAME</label>
<div class="col-md-9">
<input type="text" class="form-control" placeholder="NAME" name="pf_name" id="pf_name">
...
<div class="col-md-9">
<textarea type="text" class="form-control" placeholder="DESCRIPTION" name="pf_description" id="pf_description">
</textarea>
...
<div class="form-group row">
<label class="col-md-2 label-control" for="eventRegInput5">IMAGE</label>
<div class="col-md-9">
